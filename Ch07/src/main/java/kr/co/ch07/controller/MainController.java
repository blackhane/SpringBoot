...
public class MainController {
	...
	public String query4() {
		List<User1VO> users = repo.findUser1VOByUidAndName("a102", "홍길동");
		System.out.println("query4 결과 : " + users);
		return "redirect:/";
	}
	@GetMapping("/query5")
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a103", "이순신");
		System.out.println("query5 결과 : " + users);
		return "redirect:/";
	}
	@GetMapping("/query6")
	public String query6() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThan(22);
		System.out.println("query6 결과 : " + users);
		return "redirect:/";
	}
	@GetMapping("/query7")
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(22);
		System.out.println("query7 결과 : " + users);
		return "redirect:/";
	}
	@GetMapping("/query8")
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(22);
		System.out.println("query8 결과 : " + users);
		return "redirect:/";
	}
	@GetMapping("/query9")
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(22);
	...
	public String query12() {
		List<User1VO> users = repo.findUser1VOByNameStartsWith("강");
	...
	public String query18() {
		String count = repo.countUser1VOByUid("a101");
		System.out.println("query18 결과 : " + count);
		return "redirect:/";
	}
	@GetMapping("/query19")
	public String query19() {
		String count = repo.countUser1VOByName("이순신");
	...
	public String query22() {
		List<User1VO> users = repo.selectUserByWithParam("이순신");
